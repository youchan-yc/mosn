...
func newHostStats(clustername string, addr string) *types.HostStats {
	...
	return &types.HostStats{
		...
		UpstreamServerReportedDuration:                 s.Histogram(metrics.UpstreamServerReportedDuration),
		UpstreamServerReportedDurationEWMA:             s.EWMA(metrics.UpstreamServerReportedDurationEWMA, alpha),
		UpstreamServerReportedDurationTotal:            s.Counter(metrics.UpstreamServerReportedDurationTotal),
